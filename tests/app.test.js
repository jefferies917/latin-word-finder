...
const app_1 = require("../src/app"); // Update the path to your script file
describe('TaskWordFinder', () => {
    let taskWordFinder;
    beforeAll(() => {
        // Initialize TaskWordFinder with a test dictionary file
        taskWordFinder = new app_1.TaskWordFinder('src/dictionary.txt'); // Provide a test dictionary file
    });
